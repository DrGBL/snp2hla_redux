...
from src.ALLELES2HPED import ALLELES2HPED
...
class HLA_Imputation_BEAGLE5(object):
    ...
    def __init__(self, idx_process, MHC, _reference, _out, _hg, __OVERLAP__, _window, _ne, _nthreads,
                 ...
                 f_remove_raw_IMP_results=False, f_measureAcc_v2=False, _iter=12, _burnin=3):
        ...
        if _MultP == 1:
                ...
                for _overlap in __overlap__:
                    ...
                    self.dict_IMP_Result[_exonN][_overlap] = \
                        self.IMPUTE(MHC, _out, IMPUTATION_INPUT, self.dict_ExonN_Panel[_exonN] + '.phased.vcf',
                                    ...
                                    self.__AVER__, self.dict_ExonN_AGM[_exonN], f_prephasing=f_prephasing, _iter=_iter, _burnin=_burnin)
            ...
            dict_Pool = {_exonN: {_overlap: pool.apply_async(self.IMPUTE, (MHC, _out, IMPUTATION_INPUT, self.dict_ExonN_Panel[_exonN] + '.phased.vcf', _overlap, _exonN, _window, _ne, _nthreads, self.__AVER__, self.dict_ExonN_AGM[_exonN], f_prephasing, _iter, _burnin))
                                  for _overlap in __overlap__}
                         for _exonN in __EXON__}
    ...
    def IMPUTE(self, MHC, _out, _IMPUTATION_INPUT, _REF_PHASED_VCF, _overlap, _exonN, _window, _ne, _nthreads,
               _aver_erate, _Refined_Genetic_Map, f_prephasing=False, _iter=12, _burnin=3):
        ...
        if self.FLAG_AdaptiveGeneticMap: # With Adatpive Genetic Map
            ...
            command = '{} \
                ...
                _Refined_Genetic_Map, _window, _nthreads, _iter, _burnin)
            # print(command)
