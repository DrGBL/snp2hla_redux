...
from MakeGeneticMap.src.checkInput import FixInput
...
class CookHLA_MakeGeneticMap(object):
    ...
    """
    Main wrapper for MakeGeneticMap.

    """

    def __init__(self, _input, _hg_input, _reference, _out, _mach_mcmc_rounds):
        ...
        self.GeneticMap = MakeGeneticMap(_input, _reference, _out, _mach_mcmc_rounds)
...
if __name__ == '__main__':
    ...
    ###########################################################################################
        ...
        2. Reference panel from MakeReference (PLINK + Phased Beagle file (*.{bed,bim,fam,FRQ.frq,bgl.phased,markers})
    ...
    CookHLA_MakeGeneticMap(args.input, args.human_genome, args.reference, args.out, args.mach_mcmc_rounds)